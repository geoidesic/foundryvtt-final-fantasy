    ...
    .bp.flexrow.justify-flexrow-vertical 
      ...
      .flex
        .flexcol
          ...
          .flex.max.header 
            .header 
              DocInput(type="number" name="BP" min=0 valuePath="system.points.BP.max")

      .flex.header.val
        .header
          DocInput(type="number" name="BP" min=0 max="{$actor.system.points.BP.max}" valuePath="system.points.BP.val")
